...
export LANGUAGE=C
export LANG=C
folder=/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/ubuntu
...
touch /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/ubuntu/opt/chroot
